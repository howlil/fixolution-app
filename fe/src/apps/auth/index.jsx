  ...
  return (
    <section
      className={`relative h-screen bg-black bg-opacity-95 ${
        daftar ? "grid grid-cols-1 md:grid-cols-2" : "flex justify-center items-center"
      }`}
    >
      <img
        src={img}
      ...
      {daftar ? (
        <>
          <section className="p-8 md:p-16 lg:p-24 mt-24">
            ...
            <h3 className="text-white leading-snug text-lg md:text-2xl lg:text-3xl">
              ...
              <span className="text-col text-lg md:text-2xl lg:text-3xl px-2">inside YOU,</span>
              Enjoy your Journey
            </h3>
          </section>
